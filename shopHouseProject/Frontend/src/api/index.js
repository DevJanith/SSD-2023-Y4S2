...
export const signIn = (formData) =>
  ShopHouseAPI.post("/user/sign-in", formData);
export const signUp = (formData) =>
  ShopHouseAPI.post("/user/sign-up", formData);
export const fetchUsers = () => ShopHouseAPI.get(`/user/all`);
export const fetchUser = (id) => ShopHouseAPI.get(`/user/${id}`);
export const fetchUserAccordingTopType = (userType) =>
  ShopHouseAPI.get(`/user/${userType}`);
...
export const updateItem = (id, newItem) =>
  ShopHouseAPI.patch(`/item/${id}`, newItem);
export const getoneItem = (id) => ShopHouseAPI.get(`item/${id}`);
export const getItemReport = (filter) =>
  ShopHouseAPI.post("/item/report", filter);
...
export const getProductReport = (filter) =>
  ShopHouseAPI.post("/product/report", filter);
